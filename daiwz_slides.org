...
#   - 将逻辑关系解释为相关性;
#   - FOL规则→概率图模型.
# {{{d(fragment fade-in,,,8)}}}
# {{{rbold(难点)}}}
# - FOL规则学习和图模型结构学习均为NP难{{{bsup([24])}}};
# - 只能在小数据中学习.
# {{{ed()}}}
# {{{ed()}}}
# {{{d(rightcol fragment fade-in,,,7)}}}
# #+ATTR_HTML: :style margin:5px auto;
#[[./figs/dissertation/mln.png]] 
# {{{d(scalebox60 flex-box,flex-direction:column;margin:0;flex-wrap:none auto;width:450px;height:600px)}}}
# \begin{align}
...
# \end{align}
# {{{d(,width:700px;font-size:1.19em)}}}
...
\end{equation}
{{{ed()}}}
{{{d(fragment fade-in,font-size:0.8em,,3)}}}
...
{{{ed()}}}
{{{ed()}}}
{{{d(remarkbox fragment fade-in,font-size:0.8em,,4)}}}
...
\end{align}
{{{d(popupbox fragment fade-in,position:absolute;top:17%;left:7%;font-size:0.8em,,1)}}}
- $path_0$: 作者 $X_1$ 和 $X_2$ 发表了标题一样的论文；
...
{{{bbold(鞋子湿了)}}}
- 是因为下雨还是草坪喷水器？
{{{d(org-center fragment fade-in,margin:auto,,1)}}}
#+BEGIN_SRC prolog :exports code
% 领域知识 KB
...
\end{equation}
{{{ed()}}}
{{{d(fragment fade-in,width:100%,,3)}}}
...
\]
{{{ed()}}}
{{{d(remarkbox fragment fade-in,margin:20px auto,,2)}}}
...
- 感谢所有 LAMDA 的师兄师姐和师弟师妹们, 他们对我的帮助和关心让我的这八年博士生生涯得以顺利完成, 他们的可爱和有趣也让这八年生活充满了欢笑和色彩. 特别感谢胡毅奇、杨杨、王璐、沈芷玉、侯博建和赵鹏等师弟师妹们在科研之外事务中对我的帮助.
