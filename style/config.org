...
# reveal.js options
#+reveal_init_options: history:true, fragmentInURL:true, margin:0.1, minScale:0.5, maxScale:2.5, width:1920, height:1080, mouseWheel:true, keyboard: {37: function() {Reveal.navigatePrev();},38: function() {Reveal.navigatePrev();}, 39: function() {Reveal.navigateNext();}, 40: function() {Reveal.navigateNext();},}, slideNumber:true
...
#+macro: cimg @@html:<img src="$1" width="$2" style="box-shadow:none;margin:20px auto;float:none;$3"/>@@
#+macro: cwimg @@html:<img src="$1" width="$2" style="box-shadow:none;margin:20px auto;background-color:#FFFFFF;float:none;$3;"/>@@
#+macro: wbimg @@html:<img src="$1" width="$2" style="box-shadow:none;border:$3 solid #FFFFFF;background-color:#FFFFFF;$4"/>@@
#+macro: cwbimg @@html:<img src="$1" width="$2" style="box-shadow:none;border:$3 solid #FFFFFF;margin:20px auto;background-color:#FFFFFF;float:none;$4"/>@@
...
#+macro: rbold @@html:<font color="#CC9393" style="font-size:$2"><b>$1</b></font>@@
#+macro: bbold @@html:<font color="#8CD0D3" style="font-size:$2"><b>$1</b></font>@@
...
# extra settings
#+html_head: <script type="text/javascript" id="MathJax-script" async src="https://cdnjs.cloudflare.com/ajax/libs/mathjax/3.0.0/es5/latest?tex-mml-chtml.js"></script>
