...
#+macro: wimg @@html:<img src="$1" width="$2" style="box-shadow:none;background-color:#6F6F6F;$3"/>@@
#+macro: cimg @@html:<img src="$1" width="$2" style="box-shadow:none;margin:20px auto;float:none;$3"/>@@
#+macro: cwimg @@html:<img src="$1" width="$2" style="box-shadow:none;margin:20px auto;background-color:#6F6F6F;float:none;$3;"/>@@
#+macro: wbimg @@html:<img src="$1" width="$2" style="box-shadow:none;border:$3 solid #FFFFFF;$3"/>@@
#+macro: cwbimg @@html:<img src="$1" width="$2" style="$3;box-shadow:none;border:$3 solid #FFFFFF;margin:20px auto;float:none;$3"/>@@
