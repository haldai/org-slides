...
#+macro: wimg @@html:<img src="$1" width="$2" style="box-shadow:none;background-color:#6F6F6F"/>@@
#+macro: cimg @@html:<img src="$1" width="$2" style="box-shadow:none;margin:20px auto;float:none"/>@@
#+macro: cwimg @@html:<img src="$1" width="$2" style="box-shadow:none;margin:20px auto;background-color:#6F6F6F;float:none"/>@@
#+macro: wbimg @@html:<img src="$1" width="$2" style="box-shadow:none;border:$3 solid #FFFFFF"/>@@
#+macro: cwbimg @@html:<img src="$1" width="$2" style="box-shadow:none;border:$3 solid #FFFFFF;margin:20px auto;float:none"/>@@
