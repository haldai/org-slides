...
# reveal.js options
#+reveal_init_options: history:true,fragmentInURL:true,margin:0.04,minScale:0.5,maxScale:2.5,width:1280,height:960,
...
#+reveal_init_options: center:false, display: 'block',
#+reveal_init_options: transition: 'fade', transitionSpeed: 'fast',
#+reveal_init_options: chalkboard: { boardmarkers: [ { color: '#CC9393', cursor: 'url(' + path + 'img/boardmarker-red.png), auto'}, { color: '#8CD0D3', cursor: 'url(' + path + 'img/boardmarker-blue.png), auto'}, { color: '#FFFFEF', cursor: 'url(' + path + 'img/boardmarker-black.png), auto'} ] },
...
# reveal.js plugins
#+reveal_plugins: (markdown notes search zoom RevealChalkboard)
...
#+macro: fsp @@html:<span class="fragment" data-fragment-index="$1" style="$2">@@
#+macro: ssp @@html:<span style="$1">@@
#+macro: esp @@html:</span>@@
...
# extra settings
#+html_head: <script type="text/javascript" src="style/js/reveal.js/plugin/chalkboard/plugin.js"></script>
#+html_head: <link rel="stylesheet" href="style/js/reveal.js/plugin/chalkboard/style.css">
# +html_head: <script type="text/javascript" src="style/js/pangu.min.js"></script>
# +html_head: <script type="text/javascript" src="style/js/pangu.config.js"></script>
